                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        if (snapshot.exists()){
                            ...
                            if (tipo.equals("recibido")){
                                ...
                                UserRef.child(user_id).addValueEventListener(new ValueEventListener() {
                                    ...
                                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                                        ...
                                        if (snapshot.hasChild("imagen")) {
                                            ...
                                            Picasso.get().load(img).placeholder(R.drawable.welcome).into(holder.images);
                                        }
                                        ...
                                        holder.estados.setText("Quiere contactar contigo..");
                                ...
                                Button solicitu_aceptar =holder.itemView.findViewById(R.id.solicitud_aceptar_botoon);
                                solicitu_aceptar.setText("ENVIADA");
                                holder.itemView.findViewById(R.id.solicitud_cancelar_botoon).setVisibility(View.GONE);
                                    ...
                                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                                        ...
                                        holder.itemView.setOnClickListener(new View.OnClickListener() {
                                            ...
                                            public void onClick(View v) {
                                                ...
                                                AlertDialog.Builder builder = new AlertDialog.Builder(getContext());
                                                builder.setTitle("¿Estas seguro que deseas cancelar la solicitud?");
                                                builder.setItems(opciones, new DialogInterface.OnClickListener() {
                                                    @Override
                                                    public void onClick(DialogInterface dialog, int i) {
                                                        if (i == 0){
                                                                ...
                                                                public void onComplete(@NonNull Task<Void> task) {
                                                                    if (task.isSuccessful()){
                                                                        SolicitudesRef.child(user_id).child(CurrentUserId).removeValue().addOnCompleteListener(new OnCompleteListener<Void>() {
                                                                            @Override
                                                                            public void onComplete(@NonNull Task<Void> task) {
                                                                                Toast.makeText(getContext(), "Cancelaste el requerimiento..", Toast.LENGTH_SHORT).show();
                                                                            }
                                                                        });
                                                                    }
                                                                }
